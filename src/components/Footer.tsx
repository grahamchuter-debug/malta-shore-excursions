  ...
  return (
    <footer className="footer-depth mt-auto text-white">
        ...
        <div className="container-wide grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-coastal-100/70 leading-relaxed">
              Helping cruise passengers choose between Valletta, Mdina, the Three Cities, Gozo and the
              Blue Grotto with honest independent advice for every day ashore.
            </p>
          </div>
          <div>
            <h3 className="mb-3 text-sm font-medium text-white/90">Choose your Malta</h3>
            <ul className="space-y-1.5 text-sm text-coastal-100/70">
              ...
              <li><Link href="/compare" className="hover:text-white">Compare Malta options</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-coastal-100/70">
              <li><Link href="/cruise-planner" className="hover:text-white">Malta Cruise Planner</Link></li>
              <li><Link href="/port-guide" className="hover:text-white">Malta Port Guide</Link></li>
              <li><Link href="/shore-excursions" className="hover:text-white">Shore Excursions</Link></li>
      ...
      <div className="border-t border-white/10 px-4 py-4 text-center text-xs text-coastal-300/75">
        &copy; {year} {SITE.name}. Independent Malta cruise planning resource — not affiliated with any
        cruise line or the Valletta Cruise Port. {SITE.domain}
      </div>
    </footer>
  );
}
