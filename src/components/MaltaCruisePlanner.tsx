  ...
  return (
    <div className="card-feature">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Visiting Malta</label>
          <select
            value={visitType}
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">
            ...
            minute return buffer. Gozo and south-coast routes need extra contingency for ferries and
            weather.
          </p>
        </div>
      )}
