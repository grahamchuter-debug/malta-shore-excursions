  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide">
        ...
        <h2 className="section-title mt-2">Browse Malta by the day you want</h2>
        <p className="section-subtitle">
          Fortress cities, ancient temples, coastal villages and Gozo — with the practical detail a cruise
          day requires.
        </p>
