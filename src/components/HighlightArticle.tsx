...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="Malta for Cruise Passengers" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Malta guides</h2>
