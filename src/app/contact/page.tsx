...
const path = "/contact";
const description = `Contact ${SITE.name} — an independent Malta cruise planning resource. Reach us by email for questions about our guides.`;
...
export default function ContactPage() {
  return (
    <>
      ...
      <PageHero
        title="Contact Us"
        subtitle="Questions about a guide, a shore excursion or planning your Malta day ashore — we're happy to help."
        compact
      />
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
            <p>
              {SITE.name} is an independent Malta cruise planning resource. We don&apos;t run a booking
