...
export const metadata = buildMetadata({
  ...
  description:
    "The Malta cruise port guide: the Grand Harbour terminal, the climb into Valletta, the Barrakka Lift, transport onward and sensible return-to-ship planning.",
  path,
  image: siteImages.port.src,
  imageAlt: siteImages.port.alt,
  keywords: ["Malta cruise port", "Valletta cruise terminal", "Barrakka Lift", "Grand Harbour cruise port"],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Malta Port Guide", path },
];
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-10 card-accent">
            ...
            <p className="mt-2 text-sm text-gray-600">
              See the Malta cruise port guide in the context of a specific destination, or browse carefully
              selected shore excursions built around this same terminal.
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              <Link href="/malta-cruise-port" className="btn-secondary text-sm">
                Malta Cruise Port — quick reference
              </Link>
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideContent.faqs} title="Malta Port Guide — FAQs" />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
