...
const description = `How ${SITE.name} selects, lists and ranks Malta shore excursions and planning guides — our editorial methodology.`;
...
const CRITERIA = [
  ...
  },
  {
    ...
    body:
      "Every excursion and guide is written with your ship's all-aboard time in mind. We build in return-buffer advice by default, and we flag itineraries — such as Gozo's ferry crossing — that carry more inherent timing risk.",
  },
];
...
export default function MethodologyPage() {
  return (
    <>
      ...
      <PageHero
        title="Our Methodology"
        subtitle="How we select, list and rank Malta shore excursions and planning guides — in plain terms."
        compact
      />
