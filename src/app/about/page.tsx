...
export const metadata = buildMetadata({
  title: "About",
  description:
    "About Malta Shore Excursions — an independent cruise planning resource for passengers arriving at the Grand Harbour, Valletta.",
  path,
});
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="An independent planning resource built for cruise passengers — your gateway to Malta from the Grand Harbour."
        compact
      />
      <section className="section-padding">
        <div className="container-wide max-w-3xl prose prose-gray">
          ...
          <div className="mt-8 space-y-4 text-gray-700 leading-relaxed">
            <p>
              {SITE.name} is an independent planning resource for cruise passengers calling at Malta.
              Whether you have half a day ashore or a genuinely long call, our goal is to help you choose
              the best version of Malta for your time in port — not just browse a catalogue of tours.
            </p>
            <p>
              We focus on the practical decisions that shape a good Malta cruise day: Valletta or Mdina,
              whether independent exploring suits your hours, when a private tour beats a large coach, and
              how to build a realistic return-to-ship buffer for the Barrakka Lift, a harbour ferry, or the
              Gozo crossing.
            </p>
            <p>
