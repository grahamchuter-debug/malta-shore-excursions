...
export const metadata = buildMetadata({
  ...
  description:
    "Compare Malta's shore excursion options honestly — Valletta or Mdina, Malta or Gozo, hop-on hop-off or a guided tour — before you book.",
  path,
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({
            title: "Compare Excursion Options",
            description: "Compare Malta's shore excursion options honestly.",
            path,
          }),
        ]}
      />
      <PageHero
        ...
        title="Compare Your Malta Options"
        subtitle="Clear, honest comparisons — Valletta or Mdina, Malta or Gozo, private touring or a coach tour — without overselling any single option."
        compact
      />
