...
export const metadata = buildMetadata({
  ...
  description:
    "Carefully selected Malta shore excursions from the Grand Harbour cruise port — Valletta, Mdina, the Three Cities, the Blue Grotto and Gozo, with honest cruise-day timing.",
  ...
  keywords: [
    ...
    "Mdina shore excursion",
    "Gozo shore excursion",
  ],
});
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({
            title: "Shore Excursions",
            description: "Carefully selected Malta shore excursions from the Grand Harbour cruise port.",
            path: "/shore-excursions",
          }),
        ]}
      />
      <PageHero
        ...
        title="Malta Shore Excursions"
        subtitle="Cruise-timed tours for Valletta, Mdina, the Three Cities, the Blue Grotto and Gozo — with editorial reasoning and reliable return-to-ship planning."
        compact
      />
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="mt-6 max-w-2xl text-gray-600">
            ...
            <Link href="/compare-malta-shore-excursions" className="font-semibold text-coastal-700 hover:underline">
              Compare Malta Shore Excursions
            </Link>{" "}
            guide, or read our{" "}
            <Link href="/best-malta-shore-excursions" className="font-semibold text-coastal-700 hover:underline">
